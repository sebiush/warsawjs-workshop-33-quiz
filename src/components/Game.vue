<template>
  <div class="c-game o-vertical-fill has-text-centered">
    <div class="o-vertical-fill__item o-vertical-fill__item--fixed">
      <div class="c-game__question-title">Question for ${{currentQuestion.reward}}</div>
      <div class="c-game__question-difficulty">Difficulty: {{currentQuestion.difficulty}}</div>
      <div class="c-game__question-category">Category: {{currentQuestion.category}}</div>
    </div>
    ...
    <div class="c-game__answers o-vertical-fill__item o-vertical-fill__item--fixed">
      <div class="columns is-multiline">
        <div v-for="(answer, index) in currentQuestion.answers" :key="index" class="column is-half">
          <div
